...
A meaning-changing widening of SEQ-002, still naming the fingerprint accepted at revision 4.

<!-- session-flow:scope -->
Acceptance is a normalized fingerprint of:

* the scope text and the repository bindings
* the required delivery target
* the work-root commits of the referenced behaviour and criteria documents
* every task record filed under the item

Reflowing a paragraph does not invalidate acceptance; changing what the scope asks for does.
<!-- /session-flow:scope -->
