...
Session workflow orchestration for Claude Code. A development lifecycle chain from research through release, with dependency-aware task planning and agent dispatch.

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
![Skills: 8](https://img.shields.io/badge/Skills-8-green)
...
session-init ──> research-design ──> task-planning ──> delegation ──> post-impl ──> release
 (one-time)       (collaborative      (break into       (dispatch      (refine,       (version bump,
                   brainstorming)      session tasks)    agents)        audit, test)   package, verify)
                                                                           │
                                                                     update-architecture
```
...
Standard and Quick scopes can add individual steps as extras (e.g., Quick + architecture docs).

When the security audit is included, you choose how it runs:
- **Sub-agent** — dispatches a Sonnet agent (faster, lower cost)
...
|-----------|-------------|
| All 8 skill metadata (always loaded) | ~800 |
| Largest single skill body (research-design) | ~2,500 |
| Typical active session | ~3,300 |
